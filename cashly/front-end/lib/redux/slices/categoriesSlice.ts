...
export const createCategory = createAsyncThunk("categories/createCategory", async (data: CategoryCreateDto) => {
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchCategories.fulfilled, (state, action) => {
        ...
        state.categories = action.payload.sort((a, b) => (a.categoryName.toLowerCase() > b.categoryName.toLowerCase() ? 1 : -1));
      })
    ...
    builder
      ...
      .addCase(createCategory.fulfilled, (state, action) => {
        ...
        state.categories.sort((a, b) => (a.categoryName.toLowerCase() > b.categoryName.toLowerCase() ? 1 : -1));
